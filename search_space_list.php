        ...
        <div id="wrapper-inner">
            ...
            <div id="content">
                ...
                <div class="container">
					...
					<?php
						$sql_query = "select a.*, b.*, c.* from supply_space_list a LEFT OUTER JOIN user_list b on a.provider = b.uid LEFT OUTER JOIN supply_list c on a.id = c.s_id  where s_name like '%$search_list%' order by post_date DESC LIMIT ".$offset.",".$pagesize."";
                        $result = mysqli_query($db_conn,$sql_query);
						while($row = mysqli_fetch_array($result)){
								if($row['s_status'] == "on"){
									echo "<div class='single-member effect-2'>";
										echo "<div class='member-image'>";
											echo "<a href='supply_space_detail.php?id=".$row["id"]."' target='_blank'><img src='".$row["image"]."' alt='Member' ></a>";
										echo "</div>";
