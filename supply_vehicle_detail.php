		...
		<div id="ContentContainer">
			<!--<input id="back" type="button" onClick="history.back()" value="回到上一頁"></input>-->
                ...
                <table id="ThisTable" border="0">
                	<tr>
                    	<th height="100" colspan="4" scope="row" ><h2 id="title">目的地：<?php echo $row["destination"]?></h2><hr size="1" color="#b3b3b3"/></th>
                    </tr>
                    <tr>
                    	<th id="imgbckcolor" style="text-align: center;width:20%;" rowspan="12" scope="row">
							<div class="example"><img src="<?php echo $row["image"]; ?>" class="img-rounded"/></div>
						</th>
                    	<th width="1%" rowspan="12" scope="row"></th>
                    	<td width="200" id="pp" style="border-top:0px solid white"><span style="color:#808080">出發日期與時間：&nbsp;&nbsp&nbsp;&nbsp;</span><?php echo date('d M Y \o\n g:ia',strtotime($row["vehicle_date"]))?></td>
                    	<th width="35%" rowspan="12" scope="row">
							<div class="owned">
							<?php
								if($row["picture"]==null){
									$pic = "img/selfie.png";
							...
							?>
                           	<?php if(isset($_SESSION['user_id'])){ ?>
                            	<form action="<?php echo 'supply_trade_confirm.php?id='.$row['id'].'&type=vehicle' ?>" method="post" style="border:1px solid #e6e6e6;padding:20px;border-radius:5px;margin-top:-20px;background:#f2f2f2;">
                    ...
                    <tr>
                    	<td><span style="color:#808080">集合地點:&nbsp;&nbsp&nbsp;&nbsp;</span><?php echo $row["meet_place"]?></td>
                    </tr>
                    <tr>
                    	<td><span style="color:#808080">費用：&nbsp;&nbsp&nbsp;&nbsp;</span><?php echo $row["price"]?></td>
                    </tr>
                    
                    <tr>
                    	<td><span style="color:#808080">共乘人數：&nbsp;&nbsp&nbsp;&nbsp;</span><?php echo $row["num_ppl"]?> 人，還需 <?php echo $row["rt_quantity"]?> 人</td>
                    </tr>
                    <tr>
                    	<td><span style="color:#808080">車子的種類：&nbsp;&nbsp&nbsp;&nbsp;</span>
						<?php 
							if($row["type2"]=='car'){ 
								echo "汽車";
                    ...
                    <tr>
                    	<td><span style="color:#808080">車子的款式：&nbsp;&nbsp&nbsp;&nbsp;</span><?php echo $row["vehicle_brand"]?></td>
                    </tr>
                    
                    <tr>
                    	<td><span style="color:#808080">是否接受中途下車:&nbsp;&nbsp&nbsp;&nbsp;</span><?php echo $row["mid_getoff"]?></td>
                    </tr>
                    
                    <tr>
                    	<td><span style="color:#808080">備註:&nbsp;&nbsp&nbsp;&nbsp;</span><?php echo $row["remind"]?></td>
                    </tr>
                  </table>
				  <section id="btn-click">
					...
					<p>
						...
						<a href="supply_item_like.php?id=<?php echo $id ?>&type=vehicle"><button class="btn btn-likes btn-3b icon-heart-2">Like [<?php echo $row_like['like_quantity']?>]</button></a>
					</p>
				  </section>
                  <div id="leaveMessage">
