	...
	<head>
		...
		<style type="text/css">
			...
			*{ margin:0; padding:0; list-style:none;}
			.ban2{ width:250px; height:240px; position:relative; overflow:hidden; left:0;}
	...
	<div id="wrapper">
		...
		<div id = "sub-container">
			<div class="sub-content" >
				...
				<div class="ban" id="demo1">
					...
					<div class="next1" id="next1"><img src="single-slider/images/index_tab_r.png" width="28" height="51"  alt=""/></div>
						<ul>
                        <?php
							$sql_loop = "select * from supply_goods_list a LEFT OUTER JOIN supply_list b on a.id = b.s_id where s_type='goods' order by like_quantity DESC limit 10";
							...
							while($row_loop = mysqli_fetch_array($rs_loop)){
								if($row_loop['s_status'] == 'on' && $row_loop['like_quantity'] != '0'){
									if($row_loop["image"] != 'uploadfile/itemicon.png'){
										echo "<li><p>".$row_loop['name']."</p><a href='supply_goods_detail2.php?id=".$row_loop["id"]."'><img src='".$row_loop['image']."' width='250' height='230'></a></li>";
									}
								}
							}
						?>
			...
			<div class="sub-content2">
				...
				<div class="menu">             
					<div><a href="supply_goods_list.php?type2=all"><img src="img/flag.png"/>最新發佈</a></div>
					<div><a href="supply_goods_list.php?type2=bookmark"><img src="img/like.png"/>最多收藏</a></div>
					<div><a href="supply_goods_list.php?type2=like"><img src="img/star.png"/>最多按贊</a></div>              
				</div>
			</div>
		</div>	
		<div id="contentContainer">
			<div class="MainPage">
				...
				<table border="0">
					<tr>
						<td class="form-left">用途/功能 : </td><td><?php echo $row["description"]?></td>
					</tr>
					<tr>
						<td class="form-left">品牌 : </td><td><?php echo $row["brand"]?></td>
					</tr>
					<tr>
						<td class="form-left">交易價格 : </td><td>NT$<?php echo $row["price"]?></td>
					</tr>
					<tr>
						<td class="form-left">數量 : </td><td><?php echo $row["quantity"]?> 個， 還需 <?php echo $row["rt_quantity"]?> 個</td>
					</tr>
					<tr>
						<td class="form-left">加購配件 : </td><td><?php echo $row["add_purchase"]?></td>
					</tr>
					<tr>
						<td class="form-left">是否一次性物品 : </td><td><?php echo $row["once_time"]?></td>
					<tr/>
					<tr>
						<td class="form-left">原有損壞的地方 : </td><td><?php echo $row["damaged_part"]?></td>
					<tr/>
					<tr>
						<td class="form-left">是否要配件才可使用 : </td><td><?php echo $row["fitting"]?></td>
					<tr/>
				</table>
				</div>
				</div>
				<section id="btn-click">
					...
					?>
					<p>
						<a href="supply_bookmark_like.php?id=<?php echo $id ?>&type=goods&bl=bookmark"><button class="btn btn-mark btn-3b icon-star-2">Bookmark</button></a>
						<a href="supply_bookmark_like.php?id=<?php echo $id ?>&type=goods&bl=like"><button class="btn btn-likes btn-3b icon-heart-2">Like [<?php echo $row_like['like_quantity']?>]</button></a>
					</p>
				</section>
				<div id="leaveMessage">
