	...
	<head>
		...
		<style type="text/css">
			...
			*{ margin:0; padding:0; list-style:none;}
			...
			.ban2 ul li img{width:210px;height:190px;margin-left:15px;}
	...
	<div id="wrapper">
		<div id="headerTopicContainer"></div>
			...
			<?php 
				...
				if($row["type2"] == "bytime")
				{
					$pic2 = "img/hourglass2.png";
				}
					else if($row["type2"] == "bypic")
				{
					$pic2 = "img/notepad.png";
				}
				else
				{
					$pic2="img/customer-service.png";
				}
			?></div>
		<div id = "sub-container">
			<div class="sub-content" >
				...
				<div class="ban" id="demo1">
					...
					<div class="next1" id="next1"><img src="single-slider/images/index_tab_r.png" width="28" height="51"  alt=""/></div>
						<ul>
                        <?php
							$sql_loop = "select * from supply_service_list a LEFT OUTER JOIN supply_list b on a.id = b.s_id where s_type='service' order by like_quantity DESC limit 10";
							$rs_loop = mysqli_query($db_conn,$sql_loop);
							while($row_loop = mysqli_fetch_array($rs_loop)){
								if($row_loop["type2"] == "bytime")
								{
									$pic = "img/hourglass2.png";
								}
								else if($row_loop["type2"] == "bypic")
								{
									$pic = "img/notepad.png";
								}
								else
								...
								if($row_loop['s_status'] == 'on' && $row_loop['like_quantity'] != '0'){
										...
										echo "<li><p>".$row_loop['name']."</p><a href='supply_service_detail2.php?id=".$row_loop["id"]."'><img src='$pic' width='250' height='230'></a></li>";
			...
			<div class="sub-content2">
				<form action="search_list.php" id="search_box" method="post">
				...
				<div class="menu">             
					<div><a href="supply_service_list.php?type2=all"><img src="img/flag.png"/>最新發佈</a></div>
		...
		<div id="contentContainer">
			<div class="MainPage">
				...
				<table border="0">
					...
					<tr>
						<td class="form-left">薪資計算方式 : </td><td><?php echo $row["price"]?></td>
					</tr>
					<tr>
						<td class="form-left">服務對象 : </td><td><?php echo $row["target"]?></td>
					</tr>
					<tr>
						<td class="form-left">提供的時間 : </td><td><?php echo $row["service_time"]?></td>
					</tr>
					<tr>
						<td class="form-left">工作內容 : </td><td><?php echo $row["description"]?></td>
					</tr>
					<tr>
						<td class="form-left">備註 : </td><td><?php echo $row["special"]?></td>
					</tr>
				</table>
				</div>
				</div>
				<section id="btn-click">
					...
					?>
					<p>
						<a href="supply_bookmark_like.php?id=<?php echo $id ?>&type=service&bl=bookmark"><button class="btn btn-mark btn-3b icon-star-2">Bookmark</button></a>
						<a href="supply_bookmark_like.php?id=<?php echo $id ?>&type=service&bl=like"><button class="btn btn-likes btn-3b icon-heart-2">Like [<?php echo $row_like['like_quantity']?>]</button></a>
					</p>
				</section>
				<div id="leaveMessage">
			...
			<div class="owned">
                ...
                <?php if(isset($_SESSION['user_id'])){ ?>
					<form action="<?php echo 'supply_trade_confirm.php?id='.$row['id'].'&type=service' ?>" method="post">
