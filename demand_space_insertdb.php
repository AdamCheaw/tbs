...
if($name){ 
	$sql = "insert into demand_list(type, name, image, price, description, provider, post_date, d_status, need_date) values ('$type', '$name', '$image', '$price', '$description', '$provider', '$post_date', 'on', '$date_new');";
