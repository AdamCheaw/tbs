...
.menu_body a:hover{text-decoration:none;}
			...
			<div id="firstpane" class="menu_list">
				...
				<div style="display:block" class="menu_body">
					...
					<div class="next1" id="next1"><img src="single-slider/images/index_tab_r.png" width="28" height="51"  alt=""/></div>
						<ul>
							<li><a href="javascript:"><img src="uploadfile/qqq.jpg" width="500" height="500" alt=""/><p>11111</p></a></li>
							<li><a href="javascript:;"><img src="uploadfile/room.jpg" width="500" height="500" alt=""/><p>22222</p></a></li>
							<li><a href="javascript:;"><img src="uploadfile/room2.jpg" width="500" height="500" alt=""/><p>33333</p></a></li>
						</ul>
					</div>
					</div>
				</div>
			...
			<!--<input id="back" type="button" onClick="history.back()" value="回到上一頁"></input>-->
                ...
                <table id="ThisTable" border="0">
                    ...
                    <tr>
                    	...
                    	<td width="200" id="pp" style="border-top:0px solid white"><span style="color:#808080">地點：&nbsp;&nbsp&nbsp;&nbsp;</span><?php echo $row["location"]?></td>
                    	<th width="35%" rowspan="11" scope="row">
							<div class="owned">
							<?php
								if($row["picture"]==null){
									$pic = "img/selfie.png";
							...
							<?php if(isset($_SESSION['user_id'])){ ?>
                            	<form action="<?php echo 'supply_trade_confirm.php?id='.$row['id'].'&type=space' ?>" method="post" style="border:1px solid #e6e6e6;padding:20px;border-radius:5px;margin-top:-20px;background:#f2f2f2;">
                    ...
                    <tr>
                    	<td><span style="color:#808080">大小：&nbsp;&nbsp&nbsp;&nbsp;</span><?php echo $row["space_size"]?></td>
                    </tr>
                    <tr>
                    	<td><span style="color:#808080">建議使用人數：&nbsp;&nbsp&nbsp;&nbsp;</span><?php echo $row["num_ppl"]?></td>
                    </tr>
                    <tr>
                    	<td><span style="color:#808080">價格：&nbsp;&nbsp&nbsp;&nbsp;</span><?php echo $row["price"]?></td>
                    </tr>
                    <tr>
                    	<td><span style="color:#808080">使用期限：&nbsp;&nbsp&nbsp;&nbsp;</span><?php echo date('d/m/Y',strtotime($row["space_start"]))?> 至 <?php echo date('d/m/Y',strtotime($row["space_stop"]))?></td>
                    </tr>
                    <tr>
                    	<td><span style="color:#808080">空間內附設備:&nbsp;&nbsp&nbsp;&nbsp;</span><?php echo $row["public_fac"]?></td>
                    </tr>
                    <tr>
                    	<td><span style="color:#808080">附設設備收費：&nbsp;&nbsp&nbsp;&nbsp;</span><?php echo $row["fac_with"]?></td>
                    </tr>
                    
                    <tr>
                    	<td><span style="color:#808080">提供者：&nbsp;&nbsp&nbsp;&nbsp;</span><?php echo $row["nickname"]?></td>
                    </tr>
                  </table>
                <section id="btn-click">
					...
					<p>
						...
						<a href="supply_item_like.php?id=<?php echo $id ?>&type=space"><button class="btn btn-likes btn-3b icon-heart-2">Like [<?php echo $row_like['like_quantity']?>]</button></a>
					</p>
                </section>
                <div id="leaveMessage">
	...
	<!--<script>window.jQuery || document.write('<script src="star/js/jquery-2.1.1.min.js"><\/script>')</script>
	<script src="star/js/jquery.ratyli.js"></script>
    <script src="star/js/demo.js"></script>-->
	<script type="text/javascript">
	jq('#demo1').banqh({
	box:"#demo1",//总框架
	pic:"#ban_pic1",//大图框架
