	...
	<div id="wrapper">
        ...
        <div id="wrapper-inner">
            ...
            <div id="content">
				...
				<?php
					$type2_array = array("3C","wear","book","kitchenware","furniture","camp","sport","other");
					$type2_cn = array("  /  3C","  /  穿搭","  /  書籍","  /  廚具","  /  家具","  /  露營","  /  運動","  /  其他");
					$tmp = "";
				...
				?>
				<div id="thisH1"><h1 style="color:#476b6b">物品類<?php echo "<small style='color:#808080'>$tmp</small>";?></h1></div>
                <div id="ThisFilter">
					<div id="div1">
                ...
                <div class="container">
                    <?php
						...
						}else if($type2 == 'bookmark'){
							$sql_total = "select count(*) from supply_list where s_type = 'goods' and bookmark_quantity != 'null' ";
						}else if($type2 == 'like'){
							$sql_total = "select count(*) from supply_list where s_type = 'goods' and like_quantity != 'null' ";
						}else{
                    ...
                    <?php
                        if(isset($_POST['filter'])){
							...
							if($type2 == 'all'){
                        		...
                        		$sql_query = "select a.*, b.*, c.* from supply_goods_list a LEFT OUTER JOIN user_list b on a.provider = b.uid LEFT OUTER JOIN supply_list c on a.id = c.s_id  where s_type = 'goods' and bookmark_quantity != 'null' order by ".$_POST['filter']." LIMIT ".$offset.",".$pagesize.""; 
							}else if($type2 == 'like'){
                        		$sql_query = "select a.*, b.*, c.* from supply_goods_list a LEFT OUTER JOIN user_list b on a.provider = b.uid LEFT OUTER JOIN supply_list c on a.id = c.s_id  where s_type = 'goods' and like_quantity != 'null' order by ".$_POST['filter']." LIMIT ".$offset.",".$pagesize.""; 
							}else{
							...
							if($type2 == 'all'){
                        		...
                        		$sql_query = "select a.*, b.*, c.* from supply_goods_list a LEFT OUTER JOIN user_list b on a.provider = b.uid LEFT OUTER JOIN supply_list c on a.id = c.s_id  where s_type = 'goods' and bookmark_quantity != 'null' order by ".$_GET['filter']." LIMIT ".$offset.",".$pagesize."";
							}else if($type2 == 'like'){
                        		$sql_query = "select a.*, b.*, c.* from supply_goods_list a LEFT OUTER JOIN user_list b on a.provider = b.uid LEFT OUTER JOIN supply_list c on a.id = c.s_id  where s_type = 'goods' and like_quantity != 'null' order by ".$_GET['filter']." LIMIT ".$offset.",".$pagesize."";
							}else{
							...
							if($type2 == 'all'){
								...
								$filter = "bookmark_quantity DESC";
								$sql_query = "select a.*, b.*, c.* from supply_goods_list a LEFT OUTER JOIN user_list b on a.provider = b.uid LEFT OUTER JOIN supply_list c on a.id = c.s_id  where s_type = 'goods' and bookmark_quantity != 'null' order by bookmark_quantity DESC LIMIT ".$offset.",".$pagesize."";
							}else if($type2 == 'like'){
								$filter = "like_quantity DESC";
								$sql_query = "select a.*, b.*, c.* from supply_goods_list a LEFT OUTER JOIN user_list b on a.provider = b.uid LEFT OUTER JOIN supply_list c on a.id = c.s_id  where s_type = 'goods' and like_quantity != 'null' order by like_quantity DESC LIMIT ".$offset.",".$pagesize."";
							}else{
								$filter = "post_date DESC";
