	...
	<div id="wrapper">
		...
		<div id="ContentContainer">
            <div class="MainPage">
                    ...
                    <tr>
                        <th height="100" colspan="9" scope="row" ><h2 id="title"><?php echo $row["destination"]?></h2><hr size="1" color="#b3b3b3"/></th>
                    </tr>
                    <tr>
					...
					<tr>
						<td width="4">
							<div id="adjust">
								...
								<p>出發日期 : <?php echo date('d M Y \o\n g:ia',strtotime($row["v_date"]));?></p>
								<p>可接受的費用 : <?php echo $row["price"]?></p>
